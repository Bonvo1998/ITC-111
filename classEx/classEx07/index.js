...
function changeLinkText(lnk) {
    ...
    if(lnk == "home") {
        ...
        document.getElementById('divLeft_ALinks').style.display = "none";
        document.getElementById('divRight').innerHTML = "Default content for Class Exercise Link.";
        ...
        document.getElementById('rs_Heading').innerHTML = "Assignment Discription";
